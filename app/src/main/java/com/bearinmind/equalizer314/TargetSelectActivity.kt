...
class TargetSelectActivity : AppCompatActivity() {
    ...
    private val importLauncher = registerForActivityResult(
        ...
        try {
            ...
            if (fr != null) {
                ...
                android.widget.Toast.makeText(this, getString(R.string.could_not_parse_target_file), android.widget.Toast.LENGTH_LONG).show()
            }
        } catch (e: Exception) {
    ...
    private fun onTargetSelected(entry: TargetEntry) {
        ...
        setResult(Activity.RESULT_OK)
        android.widget.Toast.makeText(this, getString(R.string.target_named, entry.name), android.widget.Toast.LENGTH_SHORT).show()
        updateActiveCard()
    }
